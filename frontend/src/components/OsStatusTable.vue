  ...
  >
    <template #bodyCell="{ column, record }">
      ...
      <template v-else-if="column.key === 'disk_usage'">
        <!-- 两列分别对应 disk_usage/disk_alarm 和 disk_home_usage/disk_home_alarm。 -->
      ...
      <template v-else-if="column.key === 'disk_home_usage'">
...
const columns: TableColumnsType = [
  ...
  { title: '磁盘使用率1', key: 'disk_usage', width: 160 },
  { title: '磁盘使用率2', key: 'disk_home_usage', width: 160 },
